        ...
        <div>
            ...
            <div>
                ...
                <select name="bedrooms" id="">
                    <option value="<?php //echo isset($update) ? $update['bedrooms'] : "1";
                                    ?>">1</option>
                    <option value="<?php //echo isset($update) ? $update['bedrooms'] : "2";
                                    ?>">2</option>
                    <option value="<?php //echo isset($update) ? $update['bedrooms'] : "3";
                                    ?>">3</option>
                    <option value="<?php //echo isset($update) ? $update['bedrooms'] : "4";
                                    ?>">4</option>
                    <option value="<?php //echo isset($update) ? $update['bedrooms'] : "5";
                                    ?>">5</option>
                    <option value="<?php //echo isset($update) ? $update['bedrooms'] : "6";
                                    ?>">6</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="bathrooms" id="">
                    <option value="<?php //echo isset($update) ? $update['bathrooms'] : "1";
                                    ?>">1</option>
                    <option value="<?php //echo isset($update) ? $update['bathrooms'] : "2";
                                    ?>">2</option>
                    <option value="<?php //echo isset($update) ? $update['bathrooms'] : "3";
                                    ?>">3</option>
                    <option value="<?php //echo isset($update) ? $update['bathrooms'] : "4";
                                    ?>">4</option>
                    <option value="<?php //echo isset($update) ? $update['bathrooms'] : "5";
                                    ?>">5</option>
                    <option value="<?php //echo isset($update) ? $update['bathrooms'] : "6";
                                    ?>">6</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="furnished" id="">
                    <option value="<?php // echo isset($update) ? $update['furnished'] : "furnished";
                                    ?>">furnished</option>
                    <option value="<?php // echo isset($update) ? $update['furnished'] : "semifurnished";
