   ...
   <div class="container">
      <div class="row wallet_options justify-content-center">
         <div class="col-md-3 wallet_op_bx">
            ...
            <a href="<?php echo $url['wallet']; ?>"><button class="wallet_op_btn active"><img class="mx-2 wallet_mob_img" src="../assets/img/recharge_wallet.svg" width="25px" style="margin-top: -10px;">Recharge wallet</button></a>
         </div>
         <div class="col-md-3 wallet_op_bx">
