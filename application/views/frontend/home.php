    ...
    <div class="container">
      <div class="home_subhead">
        <div class="row justify-content-start align-items-center">
          <div class="col-sm-3 ">
            <h2 class="home_subhead_text text-start">Trending Properties</h2>
          </div>
          <div class="col-sm-9">
              ...
              <div class="card-body">
                ...
                <div class="property_text_city">
                  <div class="row justify-content-between align-items-center">
                    <div class="col-9">
                      <span><i class="fa fa-map-marker prop_loc" aria-hidden="true"></i> Model Town, Jaipur</span>
  ...
  <section class="trending">
    <div class="container">
      <div class="home_subhead">
        <div class="row justify-content-start align-items-center">
          <div class="col-md-4 ">
            <h2 class="home_subhead_text text-start">Recently Added Properties</h2>
          </div>
