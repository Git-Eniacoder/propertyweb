    ...
    <section class="getintouch">
        <div class="container">
            <div class="getintouch_head text-center">
                <h1 class="getintouch_h1">About Us</h1>
            </div>
        </div>
    </section>
                ...
                <div class="row justify-content-center about_contain">
                    <div class="col-md-7">
                        <div class="about_text text-center">
                            ...
                            <p>We have also planned to launch "Recharge Portal" within this portal to increase our "Hello Rent India" visibility amongst users. </p>
                        </div>
                    </div>
                    <!-- <div class="col-md-5">
