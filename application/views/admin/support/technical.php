                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table " id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                      <?php foreach($technical as $value) {?>
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a class="btn btn-success mx-1" href="<?php echo base_url().'admin/support/technical/update_fetch/'.$value['support_id'] ; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button id="button" class="btn btn-success">Resolve</button>
          </form>
