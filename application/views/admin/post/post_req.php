                                      ...
                                      <?php foreach($values as $value) {?>
                                            <tr id="hide<?php echo $value['id'] ; ?>">
                                                ...
                                                <td class="d-flex">
                                                    ...
                                                    <a class="btn btn-danger mx-1 text-white del" href="<?php echo base_url() ; ?>admin/post/post_req/deletepost/<?php echo $value['id'] ; ?>" data-value="<?php echo $value['id'] ; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
