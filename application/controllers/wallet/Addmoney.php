...
class Addmoney extends My_Controller {
    ...
    public function index()
    {
       ...
       $this->data['history'] = $this->db_wallet->recharge_history($this->session->userdata("user_id"));
       ...
       $this->load->view('frontend/wallet/addmoney',$this->data);
