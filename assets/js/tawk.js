(function(global) {
    global.$_Tawk_AccountKey = '5f16a3867258dc118beea2ec';
                ...
                5: [function(e, p, q) {
                    (function(h) {
                        ...
                        q.decode = function(m) {
                            ...
                            for (var v = new ArrayBuffer(l), S = new Uint8Array(v), l = 0; l < g; l += 4) p = h.indexOf(m[l]), b = h.indexOf(m[l + 1]), t = h.indexOf(m[l + 2]), q = h.indexOf(m[l + 3]), S[e++] = p << 2 | b >> 4, S[e++] = (b & 15) << 4 | t >> 2, S[e++] = (t & 3) << 6 | q & 63;
                            return v
                        }
    ...
    (function(u) {
        ...
        try {
            ...
            var t = {
                    ...
                    "default-branding": '<span style="display:none" class="thin">We\'re</span> <img style="display:none" class="emojione" alt="\u26a1" title=":zap:" src="https://cdn.jsdelivr.net/emojione/assets/png/26a1.png?v=2.2.7">',
            ...
            v.hasPrototype = function(a, c) {
                return null === a || void 0 === a || void 0 === a[S] ? !1 : a[S] === c ? !0 : v.hasPrototype(a[S], c)
            };
            ...
            A.prototype.hasWebRTC = function() {
                var a = !0;
                return a = R ? !1 : x.getUserMedia || x.webkitGetUserMedia || x.mozGetUserMedia || x.msGetUserMedia || x.mediaDevices && x.mediaDevices.getUserMedia
            };
            ...
            ca.prototype.getPlugins = function() {
                var a, b, d = [];
                a = 0;
                for (b = x.plugins.length; a < b; a++) x.plugins[a].name && d.push(x.plugins[a].name);
                return d
            };
            ...
            wa.prototype.log = function(a, b) {
                var d;
                b && a && (b.uiVersion = "v3", b.buildVersion = "686", b.buildCommit = "715833a81766c389b87b1f8307c631404db6b167", d = {
                    type: a,
                    data: b
            ...
            wa.prototype.postForm = function(a, b) {
                ...
                R && (d.open(), d.writeln('<!DOCTYPE html><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head><body><iframe name="form-receiver" id="form-receiver"></iframe></body></html>'), d.close());
                k =
            ...
            P.prototype.storeSessionInformation = function(a, c) {
                ...
                if (!a || r.visitorSocketServer) a ? d = r.visitorSocketServer + "::" + b.viewHandler.indicator.unansweredMessages : (d =
                    k[1] || 0, b.main.previousSessionKey !== r.sessionKey && (d = 0), d = r.visitorSocketServer + "::" + d), c ? d += "::cf" : 3 === k.length && (d += "::" + k[2]), this.hasLocalStorage ? (this.setLocalStorage("twk_" + K.pageId, d), this.clearOldCookies("Tawk_" + K.pageId)) : this.setHTTPCookie("Tawk_" + K.pageId, d, !1), this.sessionInformation = d
            };
            ...
            Qa.prototype.initAudioPlayer = function() {
                ...
                if (da.supported) {
                    ...
                    da.mp3 ? k = $a : da.wav ? k = cb : da.ogg && (k = ab);
            ...
            var Da, H, xa, Ea, ta = 0,
                ...
                Ya = function() {
                    for (var a = n.getElementsByClassName(Da, "emoji-select"), c = 0; c < a.length; c++) "touchend" === b.viewHandler.clickEvent ? ib(a[c]) : b.eventHandler.listen(a[c], b.viewHandler.clickEvent, function(a) {
                ...
                Za = function(a) {
                    ...
                    y && f.isPopup ? b.viewHandler.addEmojiToInput(a) : "max" === r.chatWindowState() || f.isPopup || f.isEmbedded ? e.addEmojiToInput(a) : b.viewHandler.messagePreview && b.viewHandler.messagePreview.addEmojiToInput(a)
                },
                ua = function() {
            ...
            ua.prototype.init = function() {
                ...
                a = {
                    ...
                    ust: $_Tawk_Unstable,
                    p: f.isPopup ? K.pageName() : document.title,
                    r: document.referrer
                };
                ...
                this.socket.on("error", function(a) {
                    ...
                    if (a instanceof Error) {
                        ...
                        "TransportError" === a.type && (d.description = a.description); - 1 !== d.toString.indexOf("post") &&
                            (f = "socket post error")
                    } else d = a;
                    b.loggingHandler.logIncident(f, d);
                    c.socket.disconnect();
                    c.disconnectHandler()
                });
                ...
                this.socket.on("ready", function(a, s, f) {
                    ...
                    c.ready = !0;
                    try {
                        b.eventEmitter.emit("syncConversation", s)
                    } catch (e) {
            ...
            ua.prototype.addEventListeners = function() {
                function a(a, c) {
                    try {
                        ...
                        q.handleError("Unable to emit socket event : " +
                            a + " with data : " + JSON.stringify(c), f.fileName, f.lineNumber, f.stack)
                    }
                }
                var c = this;
                ...
                this.on("notifyMessagePreview",
                    function(a) {
                        c.socket.send("messagePreview", a, (new Date).getTime())
                    });
                ...
                this.on("notifyOfflineMessage", function(a, b) {
                    c.socket.send("service", "visitor-chat", "/v1/visitor/offline-form",
                        a, b)
                });
            ...
            Q.prototype.buildIframe = function(a, b) {
                ...
                if (R) this.documentRef.open(), this.documentRef.writeln('<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" /></head><body></body></html>'), this.documentRef.close();
                    ...
                    var d = document.implementation.createDocumentType("html", "", "");
                    this.documentRef.insertBefore(d, this.documentRef.childNodes[0]);
                    this.documentRef.head.innerHTML =
                        '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" /></head>'
                }
            ...
            ha.prototype.addPlaceholderHandler = function() {
                ...
                ga || (a = this.formData.fields) && a.forEach(function(a) {
                    ...
                    "input" !== a.type || a.isEnabled && !a.isEnabled() || (e = a.getValue ? a.getValue() : "", "input" === a.type && n.isArray(e) ? e.forEach(function(b, e) {
                        ...
                        f = b;
                        n.togglePlaceholderText(k, f, a.fieldName + e);
                        "textarea" !== k.tagName.toLowerCase() || n.trim(k.value) || (k.value = f)
                    }) : a.hiddenIE8 || (k = c.documentRef.getElementById(a.fieldName + "Field"), f = b.languageParser.translate("form",
                        a.languageKey + "Placeholder"), n.togglePlaceholderText(k, f, a.fieldName + "Field"), "textarea" !== k.tagName.toLowerCase() || n.trim(k.value) || (k.value = f)))
                })
            };
            ha.prototype.insertTranslatedTexts = function() {
                ...
                (this.formData.fields || []).forEach(function(b) {
                    ...
                    a.addPlaceholderText(b.fieldName, c, b.languageKey, null, b.labelText)
                });
                this.template = n.escapeTemplateReplacement(this.template, [{
            ...
            Y.prototype.buildForm = function() {
                ...
                if (null ===
                    ...
                    for (var d = 0, k = f[a + "Options"].fields.length; d < k; d++) {
                        ...
                        "name" === e.type ? (s.valueMaxLength = 40, s.getValue = b.visitorHandler.getNameValue, s.languageKey = "Name") : "email" === e.type ? (s.valueMaxLength = 150, s.getValue = b.visitorHandler.getEmailValue, s.validation = "isValidEmail", s.languageKey = "Email") : "message" === e.type ||
                            "textArea" === e.type ? s.valueMaxLength = 500 : "inputText" === e.type ? s.valueMaxLength = 150 : "department" === e.type ? s.getValue = b.sessionHandler.getDeparmentOptions : "choice" === e.type || "option" === e.type ? (s.type = "options", s.selections = e.selections) : "phone" === e.type && (s.valueMaxLength = 20, s.validation = "isValidPhone", s.languageKey = "Phone");
            ...
            Y.prototype.generateDynamicFields = function() {
                for (var a =
                        "", b = RegExp("__LABEL__", "gm"), d = RegExp("__ID__", "gm"), k = RegExp("__MAXLENGTH__", "gm"), f = 0, e = this.formData.dynamicFields.length; f < e; f++) {
                    var g, h = "",
                    ...
                    g && (g = g.replace(b, n.label || ""), g = g.replace(d, n.fieldName || ""), g = g.replace(k, n.valueMaxLength || ""), n.isRequired ? (g = g.replace(/__REQUIRED__/gm, "*"), this.isFormRequired || (this.isFormRequired = !0)) : g = g.replace(/__REQUIRED__/gm, ""), n.getValue && ("department" === n.fieldType ? (h = this.generateDropDownOptions(n.getValue(),
            ...
            Y.prototype.generateDropDownOptions = function(a, c, d) {
                ...
                "preChatForm" === this.formData.id || "offlineForm" === this.formData.id ? k += '<option id="department-default" value="" disabled selected>' + (c ? "* " : "") + (d ? d : b.languageParser.translate("form", "department")) + "</option>" : c || (k += '<option value="0"></option>');
                c = 0;
                for (d = a.length; c < d; c++) k += '<option value="' +
                    a[c].value + '"' + (a[c].selected ? 'selected="selected"' : "") + ">" + a[c].text + "</option>";
                return k
            };
            ...
            Y.prototype.addPlaceholderHandler = function() {
                var a, b;
                if (!ga)
                    for (var d = 0, k = this.formData.dynamicFields.length; d < k; d++) b = this.formData.dynamicFields[d], "department" !== b.fieldType && ("choice" !== b.fieldType && "option" !== b.fieldType) && (this.formData.dynamicFields[d].placeholderText = (b.isRequired ? "* " : "") + b.label, a = this.documentRef.getElementById(b.fieldName + "Field"), n.togglePlaceholderText(a, this.formData.dynamicFields[d].placeholderText, b.fieldName + "Field"), n.trim(a.value) || (a.value = this.formData.dynamicFields[d].placeholderText))
            };
            var oa = function(a) {
                var c = this;
                this.container = a;
            ...
            oa.prototype.show = function() {
                var a, c;
                if (!("max" === r.chatWindowState() && !f.isPopup || this.isPopupFocused && !b.viewHandler.popoutWin.closed || f.hideWidgetOnLoad || "restartChatForm" === b.formHandler.currentForm || "offlineForm" === b.formHandler.currentForm) &&
            ...
            oa.prototype.hide = function() {
                var a, c;
                this.container && this.container.elementReferrer && (a = this.container.getElementById("tawkchat-chat-indicator"), c = this.container.getElementById("tawkchat-chat-indicator-text"), a && "block" === a.style.display && (a.style.display = "none", b.viewHandler.handleIndicatorToggle(), y || this.container.hide()), c && (c.innerHTML = ""))
            };
            ...
            E.prototype.init = function() {
                var a = this;
                this.container && (this.wrapper || (this.wrapper = this.container.getElementById("tawkchat-message-preview-container"), f.isRTL() && (this.wrapper.className += "rtl-direction ")), y ? this.updateMobilePositions() : this.updatePositions(), f.chatPosition.subscribe(function() {
                    a.updatePositions()
                }))
            };
            E.prototype.show = function(a, c, d) {
                var k = this;
                0 !== a && (this.container && (c || d)) &&
                    (1 === a ? this.messagePreviewCount = 1 : this.messagePreviewCount++, this.messagePreviewContainer || (this.messagePreviewContainer = this.container.getElementById("tawkchat-message-preview-messages-container"), f.isCenterPositioned() ? this.messagePreviewContainer.style.maxHeight = document.documentElement.clientHeight - (document.documentElement.clientHeight / 2 - 180) - 210 + "px" : this.messagePreviewContainer.style.maxHeight = document.documentElement.clientHeight - (f.minimizedDimensions().height + f.widgetOffsetY + 300) + "px", this.toggleUploadsAction(),
                        ...
                        k.removeAllElements()
                    }, "tawkchat-message-preview-close", "mp-closeitemsclick"), this.isQuickReplyInitialized || this.initQuickReply(), this.showQuickReply(), 0 === this.messagePreviewCount ? this.hideQuickReply() : (f.showPreChatForm && !r.prechatFormSubmitted() && f.prechatOptions.fields.forEach(function(a) {
            ...
            E.prototype.toggleUploadsAction = function() {
                ...
                c && (f.showUploads() ? (c.style.display = "block", this.container.attachUserEventListener("change", function(c) {
                        ...
                        if (c && c.length) {
                            ...
                            b.viewHandler.checkUploadFileWarning(d, f);
                    ...
                    function(a) {
                        ...
                        if (b.clientY < c.top || b.clientY >= c.bottom || b.clientX < c.left || b.clientX >= c.right) b.preventDefault(), b.stopPropagation && b.stopPropagation(), n.removeClass(d, "drag-over")
                    },
            ...
            E.prototype.toggleRatingAction = function() {
                ...
                a && c && (f.showRating() ? (a.style.display = "block", this.container.attachUserEventListener(b.viewHandler.clickEvent,
                    function(a) {
            ...
            E.prototype.updateMobilePositions = function() {
                ...
                f.isCenterPositioned() ? (-1 === this.wrapper.className.indexOf("center") && (this.wrapper.className += "center"), a.top = "calc(50% - " + (0.5 * c + 20) + "px) !important", a.bottom = "auto !important", f.isRightPositioned() ?
                    (-1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right"), a.right = this.offsetX + d + 15 + 100 + "px !important", a.left = "auto !important") : (-1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left"), a.left = this.offsetX + d + 15 + 100 + "px !important", a.right = "auto !important")) : (d = b.viewHandler.minifiedBoxHeight * b.viewHandler.zoom + 30, f.isTopPositioned() ? (a.bottom = "auto !important", a.top = d + 30 + "px !important", -1 === this.wrapper.className.indexOf("top") && (this.wrapper.className +=
            ...
            E.prototype.updatePositions = function() {
                var a = {},
                    ...
                    d = f.minimizedDimensions().height;
                f.isCenterPositioned() ? (-1 === this.wrapper.className.indexOf("center") && (this.wrapper.className += "center"), a.top = "calc(50% - " + (0.5 * b + 40) + "px) !important", a.bottom = "auto !important", f.isRightPositioned() ? (-1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right"), a.right = this.offsetX + d + 15 + "px !important", a.left = "auto !important") : (-1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left"),
                    a.left = this.offsetX + d + 15 + "px !important", a.right = "auto !important")) : (f.isTopPositioned() ? (a.top = f.minimizedDimensions().height + this.offsetY + "px !important", a.bottom = "auto !important", -1 === this.wrapper.className.indexOf("top") && (this.wrapper.className += " top")) : (f.isDesktopRectangle() ? a.bottom = f.minimizedDimensions().height + this.offsetY + 10 + "px !important" : a.bottom = 80 + this.offsetY + "px !important", a.top = "auto !important", -1 === this.wrapper.className.indexOf("bottom") && (this.wrapper.className += " bottom")),
                    f.isRightPositioned() ? (a.right = this.offsetX + "px !important", a.left = "auto !important", -1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right")) : (a.left = this.offsetX + "px !important", a.right = "auto !important", -1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left")));
                this.container.massRestyle(a)
            };
            ...
            var z = TawkClass.extend({
                ...
                appendMessage: function(a) {
                    ...
                    h.buildView();
                    try {
                        bb.insertBefore(h.elementReferrer, p.getElementById("agentTypingContainer"))
                    } catch (z) {
                ...
                updateViewByStatus: function(a) {
                    ...
                    if (f.isPopup) {
                        ...
                        document.title = c ? K.pageName() + " - " +
                            n.rawDecode(c) : K.pageName()
                    }
                    "online" === a || "away" === a ? (f.showConsentForm ? b.formHandler.openForm("consentForm") : f.showPreChatForm && !r.prechatFormSubmitted() && b.formHandler.openForm("preChatForm"), this.showWidget(), p && (b.viewHandler.isMaximized || p.showBubble())) : "offline" === a && (f.hideWidgetOnOffline ? this.hideWidget() : (b.formHandler.openForm(f.showConsentForm ? "consentForm" : "offlineForm"), this.showWidget()), p && (p.hideBubble(), this.messagePreview && this.messagePreview.removeAllElements()))
                }
            });
            ...
            z.prototype.addProfileDetail = function(a) {
                ...
                a.pi || 1 < b.agents.agentsCount ? (c = new C("profileDetail", null, null, null, this.chatContainer.documentRef), k =
                    t["agent-profile-description"], c.template = n.escapeTemplateReplacement(k, [{
                        placeholder: "__POSITION_CLASS__",
            ...
            L.prototype.isValidString = function(a, b, d) {
                return d || a ? !(!a || !n.isString(a) ||
                    b && !(b && a.length <= b)) : !0
            };
            L.prototype.isValidEmail = function(a, b, d) {
                return d || a ? !!(a && n.isEmail(a) && n.isString(a) && a.length <= b) : !0
            };
            L.prototype.isValidDepartment = function(a, b, d) {
                var k;
                b = r.departments;
                if (!(d || a && "0" !== a)) return !0;
                for (k in b)
            ...
            L.prototype.isValidPhone = function(a, b, d) {
                if (!d && !a) return !0;
            ...
            var M = TawkClass.extend({
                ...
                buildView: function() {
                    var a;
                    if (this.container && (b.MinifiedStyle = b.MinifiedStyle.replace(/#tawktoLink/g, "#" + b.viewHandler.tawktoLinkName), b.MinifiedStyle = b.MinifiedStyle.replace(/#bottomContainer/g, "#" + b.viewHandler.bottomContainerName), f.showMessagePreview() ? this.initMessagePreviewContainer() : this.destroyMessagePreviewContainer(), this.chatIndicator.buildIframe(b.MinifiedStyle + f.minStyle(), !0), a = n.getElementsByTagName(this.chatIndicator.documentRef, "body")[0], a.innerHTML =
                            t["tawkchat-chat-indicator"], this.container.buildIframe(b.MinifiedStyle + f.minStyle()), this.bubbleContainer && (f.chatBubble() && this.bubbleContainer.elementReferrer ? this.bubbleContainer.buildIframe(b.MinifiedStyle + f.minStyle(), !0) : this.bubbleContainer.clear()), this.widgetDimensionsUpdated(), this.updateGreetings(), this.attachEvents(), this.inDocument = !0, f.isDesktopRectangle())) {
            ...
            M.prototype.bubbleSettingsChanged = function() {
                ...
                b && (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.elementReferrer) && (a && (a.type && "default" !== a.type || this.bubbleContainer.elementReferrer &&
                    this.bubbleContainer.insertCssFile(".bubble-text-color{color:" + (f.chatBubble() ? f.chatBubble().fgc : "#ffffff") + ";}", !0), a && (this.bubbleContainer || (this.bubbleContainer = new Q(n.getRandomName(), n.getGenericStyle({
                        ...
                        !0), this.bubbleContainer.buildIframe(b.MinifiedStyle + f.minStyle(), !0)))), this.createBubble(), this.attachBubbleEvents())
            };
            ...
            M.prototype.calculateBubblePositioning = function(a, b, d, k, e, g, h) {
            ...
            M.prototype.agentBarChanged = function(a) {
                ...
                f.hideWidget || (this.container.massRestyle({
                    ...
                    }), h = R && 10 > O, closeIconWidth = 16, minWidth = f.minimizedDimensions().width, minHeight = f.minimizedDimensions().height, b = f.chatBubble(), d = a - minHeight, l = b.rotate, b.type && "default" !== b.type ? (k = b.topOffset, e = b.bottomOffset, bubbleWidth = b.width, bubbleContainerHeight = b.height + closeIconWidth, g = f.isRightPositioned() ?
            ...
            var Fa = M.extend({
                ...
                createCanvasChatBubble: function() {
                    var a, b, d, k, e, g, h, l, m, n, p, q, r, t, v, x, u, w = 5,
                        y = f.chatBubble().bgc;
                    if (a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-canvas")) f.chatPosition(), a.width = "146", a.height = "85", e = a.getContext("2d"), e.clearRect(0, 0, 134, 63), e.fillStyle = y, f.isTopPositioned() ?
                        (w = 16, g = 68, r = w + 3, q = 81, t = 6, v = !1, a = 1.1, b = 1.9, d = 1.6, k = 0.85) : (g = w = 6, r = w + 63 - 3, q = 55, t = 79, v = !0, a = 0.9, b = 0.1, d = 0.4, k = 1.15), f.isRTL() ? (u = 10, closeContainerStart = u - 4, h = u + 2, l = u + 5, m = u - 2, n = u - 2, p = u + 5, q = 81, f.isTopPositioned() ? (x = v, d = 0.2, k = 1.45) : (x = !v, d = 0.6, k = 1.85)) : (u = 2, closeContainerStart = u + 134 + 4, h = u + 134 - 2, l = u + 134 - 5, m = u + 134 + 2, n = u + 134 + 2, p = u + 134 - 5, x = v), e.beginPath(), e.moveTo(u + 8, w), e.lineTo(68, w), e.lineTo(u + 134 - 8, w), e.quadraticCurveTo(u + 134, w, u + 134, w + 8), e.lineTo(u + 134, w + 63 - 8), e.quadraticCurveTo(u + 134, w + 63, u + 134 - 8,
                            w + 63), e.lineTo(u + 8, w + 63), e.quadraticCurveTo(u, w + 63, u, w + 63 - 8), e.lineTo(u, w + 8), e.quadraticCurveTo(u, w, u + 8, w), e.strokeStyle = "#e3e0e7", e.lineWidth = 2, e.stroke(), e.closePath(), e.fill(), e.beginPath(), e.arc(68, r, 10, Math.PI * a, Math.PI * b, v), e.strokeStyle = "#e3e0e7", e.lineWidth = 2, e.stroke(), e.fill(), f.isDesktopRectangle() || (f.isTopPositioned() && f.isLeftPositioned() ? q -= 30 : f.isBottomPositioned() && f.isRightPositioned() ? q += 30 : f.isCenterPositioned() && f.isRightPositioned() && (q += 30)), e.beginPath(), e.arc(q, t, 5, 0, 2 * Math.PI,
                            !1), e.strokeStyle = "#e3e0e7", e.lineWidth = 2, e.stroke(), e.closePath(), e.fill(), e.beginPath(), e.arc(h, g + 5, 10, Math.PI * d, Math.PI * k, x), e.strokeStyle = "#e3e0e7", e.lineWidth = 2, e.stroke(), e.closePath(), e.fillStyle = y, e.fill(), e.beginPath(), e.moveTo(l, g + 1.5), e.lineTo(m, g + 8), e.closePath(), e.lineWidth = 2, e.strokeStyle = f.chatBubble().fgc, e.stroke(), e.beginPath(), e.moveTo(n, g + 1.5), e.lineTo(p, g + 8), e.closePath(), e.lineWidth = 2, e.strokeStyle = f.chatBubble().fgc, e.stroke()
                }
            });
            Fa.prototype.setLinkTitle = function() {
                ...
                this.container && (c && c.setAttribute("title", b.languageParser.translate("rollover", "maximize")), a && a.setAttribute("title", b.languageParser.translate("rollover", "minimize")))
            };
            Fa.prototype.chatEnded = function() {
                ...
                a && b && (a.innerHTML = "", a.style.display = "none",
                    b.style.display = "block", d.style.marginTop = "0px")
            };
            Fa.prototype.addClassName = function() {
                var a;
                a = f.isRTL() ? " rtl-direction" : " ltr-direction";
                this.container && this.container.elementReferrer && (this.container.getElementById("tawkchat-minified-wrapper").className = n.getContrast(f.headerTxtColor) + a);
            ...
            var W = TawkClass.extend({
                init: function(a, c) {
                    ...
                    this.resizeThrottle = 0;
                    this.container = f.isPopup ? new C(n.getRandomName(), "display: none;") : new Q(n.getRandomName(), n.getGenericStyle({
                        zindex: "999999",
                        position: "static",
                        display: "none",
                        height: this.frameHeight,
                    ...
                    f.maximizedDimensions.subscribe(function(a) {
                        f.isEmbedded || (f.isPopup || y) || (d.frameHeight = a.height + "px", d.frameWidth = a.width + "px", d.container.restyle("height", d.frameHeight + " !important"), d.container.restyle("width", d.frameWidth + " !important"))
                    });
                    ...
                    f.desktopWidget.subscribe(function() {
                        f.isDesktopRectangle() ? (d.wrapper.removeClass("roundWidget"), d.container.documentRef.getElementById("minimizeChat").className = "headerBoxLink", "br" === f.chatPosition() ? d.container.documentRef.body.className = "right" :
                            d.container.documentRef.body.className = "left") : (d.wrapper.addClass("roundWidget"), d.container.documentRef.getElementById("minimizeChat").className = "notShown")
                    });
                ...
                buildView: function() {
                    ...
                    f.isEmbedded || f.isPopup || y ? this.restyleEmbed() : "br" == f.chatPosition() ? (n.removeClass(this.container.documentRef.body, "left"), n.addClass(this.container.documentRef.body, "right")) : (n.removeClass(this.container.documentRef.body, "right"), n.addClass(this.container.documentRef.body, "left"));
                    this.addClassName();
                    this.updateGreetings();
                    this.toggleSound();
                    this.attachEvents();
                ...
                toggleUploadsAction: function() {
                    ...
                    }, this.container.attachUserEventListener("dragleave", c, "innerWrapper", "textareaContainerDragLeave"), this.container.attachUserEventListener("dragend", c, "innerWrapper", "textareaContainerDragEnd"), this.container.attachUserEventListener("drop", function(c) {
                        c.preventDefault();
                        c.stopPropagation && c.stopPropagation();
                ...
                toggleEmojiAction: function() {
                    ...
                    f.showEmoji() ? (e.innerHTML = t.loader, d.style.display = "block", n.addClass(c, "with-emoji"), "undefined" === typeof H && Wa(this.container.documentRef), this.container.attachUserEventListener(b.viewHandler.clickEvent, function(c) {
                    ...
                    }, "viewEmoji", "viewEmojiClick"), this.wrapper.attachUserEventListener(b.viewHandler.clickEvent, function(c) {
                    ...
                    }, null, "maxWidgetClick")) : (d.style.display =
                        "none", n.removeClass(c, "with-emoji"))
                },
                attachEvents: function() {
                    var a = this,
                        c = this.container.documentRef.getElementById("tooLongMsgNotification"),
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function(c) {
                        f.isPopup ? g.close() : (b.eventHandler.cancelEvent(c), b.sessionHandler.notifyWindowState("min"), a.closeMenu())
                    ...
                    if (y) {
                        ...
                        e && (fb.initElement(e, function(d, f) {
                        ...
                        a.resizeTextArea()
                    }, null, "chatinputkeyup"), this.chatTextarea.attachUserEventListener("keydown", function(d) {
                        ...
                        setTimeout(function() {
                            f.value ? (e.style.display = "none", k.className = k.className.replace("additionalPadding", ""), n.removeClass(k, "additionalPadding")) : (e.style.display = "block", k.className += " additionalPadding ", n.addClass(k, "additionalPadding"))
                        }, 0);
                        b.chatHandler.sendTextPreview(d)
                    }, null, "chatinputkeydown"), this.chatTextarea.attachUserEventListener("blur",
                        function(c) {
                            c = b.eventHandler.getTargetElement(c);
                    ...
                    this.container.attachUserEventListener(h, function(c) {
                        ...
                        var d = 0 < q;
                        "touchmove" === c.type ? p = c.changedTouches[0].clientY :
                            "touchstart" === c.type ? m = c.touches[0].clientY : "touchend" === c.type ? d = m < p : y || a.chatViewScroll(c);
                ...
                toggleSound: function() {
                    ...
                    a && b && (f.soundOn() ? (a.style.display = "block", b.style.display = "none") : (a.style.display =
            ...
            W.prototype.restyleEmbed = function() {
                ...
                f.isPopup && (this.wrapper.addClass("popout"), n.updateFontStylesheet(document));
            ...
            W.prototype.updateGreetings =
                function(a) {
                    ...
                    if (this.container.elementReferrer) {
                        ...
                        if (a = a || r.pageStatus()) c = this.container.getElementById("shortMessage"), this.setChatGreetings(), c && this.chatTextarea && (a = m.getShortMessage(a), null !== a && (c.innerHTML = a, f.onlineGreeting && (a = n.rawDecode(f.onlineGreeting.actionMessage), ga ? this.chatTextarea.elementReferrer.placeholder = a : (this.chatTextarea.elementReferrer.value = a,
            ...
            W.prototype.resizeTextArea = function() {
                ...
                this.resizeThrottle = setTimeout(function() {
                    ...
                    c && n >= h ? (n = 150 < n ? 150 : n, this.isActionsContainerNotifShown && (n += 42, d.style.paddingBottom =
                        "42px"), f.style.height = 46 + (n - h) + "px", g && b.viewHandler.scrollToBottom()) : f.style.height = "46px";
                ...
                init: function() {
                    ...
                    b.eventEmitter.on("formClosed", function() {
                        ...
                        if (c)
                            ...
                            else if (a.setChatGreetings(!0), c.style.display = "block", a.wrapper.removeClass("noMenu"), b.viewHandler.checkSeenMessageViewport(), !y &&
                ...
                attachEvents: function() {
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
                        f.whiteLabel() || (f.brandingRedirect() ? g.open("https://ref.tawk.to/?utm_source=visitor-widget&utm_medium=link&utm_campaign=referral&utm_term=" +
                            K.pageId) : c.style.display = "block")
            ...
            B.prototype.scaleContent = function(a) {
                if (!this.isMaximized) {
                    ...
                    a && g && (d = Math.ceil(d * a) + 15 * a, e = Math.ceil(e * a) + 15 * a, this.minifiedWidget.container.massRestyle({
                        height: d +
                            "px !important",
            ...
            B.prototype.handleIndicatorToggle = function(a) {
                ...
                d.className = a ? d.className + " indicator-on " :
                    d.className.replace("indicator-on", "");
            ...
            B.prototype.updateWidgetPosition = function(a) {
                ...
                this.iframeContainer && (f.isCenterPositioned() ?
                    (b.top = "50% !important", b.bottom = "auto !important", b.margin = this.isMinifiedRound ? -0.5 * a + "px 0 0 0 !important" : -0.5 * a - (this.defaultHeight - 37) / 2 + "px 0 0 0 !important") : (b.margin = "0 !important", f.isTopPositioned() ? (b.top = "0px !important", b.bottom = "auto !important", d.top = this.isMinifiedRound ? "5px !important" : "-26px !important") : (b.bottom = "0px !important", b.top = "auto !important", d.bottom = this.isMinifiedRound ? "14px !important" : "0px !important")), f.isRightPositioned() ? (b.right = "0px !important", b.left = "auto !important",
                        d.right = this.isMinifiedRound ? "5px !important" : "0px !important") : (b.left = "0px !important", b.right = "auto !important", d.left = this.isMinifiedRound ? "20px !important" : "15px !important"), this.iframeContainer.massRestyle(b), this.minifiedWidget.container.massRestyle(d))
            };
            ...
            var la = z.extend({
                init: function() {
                    ...
                    f.maxStyle.subscribe(function() {
                        e &&
                            e.container.elementReferrer && e.container.insertCssFile(f.maxStyle(), !0)
                    });
                    b.chatHandler.hasChatStarted.subscribe(function(a) {
                        e.toggleEndChatOption(a)
                    })
                ...
                updateViewByStatus: function(a) {
                    this._super(a);
                    e && ("preChatForm" !== b.formHandler.currentForm && "offlineForm" !== b.formHandler.currentForm) && f.isPopup && (a = m.getShortMessage(a), document.title = a ? K.pageName() + " - " + n.rawDecode(a) :
                        K.pageName())
                },
                handleEndChat: function() {
                    e.chatEnded();
            ...
            var ya = function() {
                ...
                this.popupOnFocusHandler = function() {
                    b && (!u.connected && b.socketManager.isForcedDisconnect() ? b.main.criticalRefresh(r.serverVersion, !1, !0) : (a.hasFocus || (a.active = !0, a.hasFocus = !0, u.connected && b.socketManager.sendToConnector("popupOnFocus", !0)), a.away && u.connected && b.socketManager.sendToConnector("notifySocketStatusUpdate",
                        "online"), a.away = !1))
                };
            ...
            ya.prototype.inactivityTimeoutHandler = function() {
                b && (b.socketManager.disconnectConnector(), f.isEmbedded ? b.formHandler.openForm("inactivityOverlay") :
            ...
            ma.prototype.setup = function() {
                ...
                f.schedule ? (this.utcOffset = -1 * ((new Date).getTime() -
            ...
            Z.prototype.prepareData = function() {
                ...
                if (b) {
                    ...
                    if (-900 > d || 900 < d) d = 0;
                    this.registerData ? (this.registerData.k = c, this.registerData.d = g) : (e = b.browserData.getReferredSearchEngine(),
                        this.registerData = {
                            a: K.pageId || "",
                            k: c,
                            w: f.widgetId,
            ...
            Z.prototype.startRegister = function() {
                ...
                !a || 1E3 < (new Date).getTime() - (new Date(a)).getTime() ? (ea.setHTTPCookie("TawkConnectionTime", (new Date).getTime(), !0), this.connectionCookieInterval =
            ...
            Z.prototype.clearTimers = function() {
                ...
                ea.setHTTPCookie("TawkConnectionTime",
                    0, !0);
            ...
            na.prototype.processSettings = function(a) {
                ...
                if (!(a.wv < f.widgetVersion)) {
                    ...
                    f.isHeaderCompact = !1;
                    f.isLegacyLayout = a.isLegacyLayout || !0;
                    ...
                    f.isRTL(0 <= n.rtlLangTab.indexOf(f.locale));
                    f.chatPosition(a.pos);
                    "page" !== $_Tawk_WidgetId || y || (a.dw = "min");
                    "full" === a.dw ? (f.widgetOffsetX = 10, f.widgetOffsetY = 0) : (f.widgetOffsetX =
                        20, f.widgetOffsetY = 20);
                    ...
                    b && (c = ".theme-background-color{background-color: " + f.headerBgColor + ";}", d = ".theme-text-color{color: " + f.headerTxtColor + ";}", f.showEmoji() && (g +=
            ...
            X.prototype.load = function() {
                ...
                "undefined" !== typeof K.pageId && "undefined" !== typeof f.widgetId && (m.processSettings(u.widgetSettings), this.init(), this.isDocumentReady || (b.eventHandler.listen(document, "DOMContentLoaded", function() {
                    a.init()
            ...
            X.prototype.init = function() {
                ...
                if ("XMLHttpRequest" in g && "withCredentials" in new XMLHttpRequest && (x.cookieEnabled && !this.isDocumentReady) && (this.isDocumentReady = !0, c =
                    ...
                    y ? (f.isPopup ? b.viewHandler = new la : this.initRenderer(y), b.formHandler = new L) : (b.formHandler = new L, b.viewHandler = new jb);
            ...
            X.prototype.extractRegisterData = function(a) {
                a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/686/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
